...
public class Animation {
    ...
    private long animTime;					// Current animation time (which point in time we are through the animation process)
    private long totalDuration;				// Total animation time (complete length of the animation)
